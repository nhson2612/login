...
const FriendsRequest = ({friends}) => {
  return (
    <Paper sx={{p: 2}} >
        <Box sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          <Typography variant="body1" color="initial" >Friends Request</Typography>
          <Typography variant="body1" color="initial" >{friends.length}</Typography>
        </Box>
        <hr className='my-2' />
